$(document).ready(function() {
    ...
    $.ajax({
        ...
        data: JSON.stringify(), 
        url: "http://localhost:3000/gu4wdnfe/p3/api/v1/user",
        success: function(data){
            ...
            var input_name = document.createTextNode("Logged in as" + firstname + " " + lastname);
            name.appendChild(input_name);

            var base_page = document.getElementById("name");
            base_page.appendChild(name);
